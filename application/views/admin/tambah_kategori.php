                    ...
                    <?php foreach ($kategori as $ka) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <?= anchor('admin/tambah_kategori/edit/' . $ka['id'], '<div class="btn btn-secondary btn-sm"><i class="fas fa-edit"></i></div>') ?>

                                <?= anchor('admin/tambah_kategori/hapus/' . $ka['id'], '<div class="btn btn-secondary btn-sm"><i class="fas fa-trash"></i></div>') ?>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </table>
